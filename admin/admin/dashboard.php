...
<section class="dashboard">
   ...
   <div class="box">
      <?php
         $select_active_posts = $conn->prepare("SELECT * FROM `posts`  ");
   ...
   <div class="box">
      ...
      ?>
       <?php
        $select_account = $conn->prepare("SELECT * FROM `rec`");
      $select_account->execute();
      $numbers_of_rec = $select_account->rowCount();
      ?>
   ...
   <div class="box">
   <?php
         $select_users = $conn->prepare("SELECT * FROM `rec`");
         $select_users->execute();
         $numbers_of_users = $select_users->rowCount();
      ?>
      <h3><?= $numbers_of_rec; ?></h3>
      <p>Recipent account</p>
      <a href="rec_accounts.php" class="btn">see Recepents</a>
   </div>
   <div class="box">
      <?php
