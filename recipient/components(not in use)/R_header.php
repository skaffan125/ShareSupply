...
<header class="header">
   ...
   <a href="dashboard.php" class="logo">RECIPIENT <span>SITE</span></a>
   ...
   <nav class="navbar">
      ...
      <a href="view_posts.php"><i class="fas fa-eye"></i> <span>Messages</span></a>
   ...
   <div class="flex-btn">
      ...
      <a href="RRegister.php" class="option-btn">register</a>
   </div>
