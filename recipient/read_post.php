...
<section class="read-post">
   ...
   <?php
      $select_posts = $conn->prepare("SELECT * FROM `posts` WHERE R_id = ? AND id = ?");
   ...
   <form method="post">
      ...
      <div class="posts-content2"><?= $fetch_posts['image']; ?></div>
   ...
   <form method="POST" action="display_pdf.php">  
         <button type="submit" formaction="display_pdf.php?post_id=<?= $post_id; ?>">VIEW PDF</button>
     </form> 
   <?php
         }
      }else{
...
<section class="comments" style="padding-top: 0;">
   ...
   <p class="comment-title">Private Comment </p>
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <button type="submit" class="inline-delete-btn" name="delete_comment" onclick="return confirm('delete this comment?');">delete Private comment</button>
      </form>
   </div>
   <?php
         }
