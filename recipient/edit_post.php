...
if(isset($_POST['save'])){
   ...
   $update_post = $conn->prepare("UPDATE `posts` SET title = ?, content = ?, category = ? WHERE id = ?");
   $update_post->execute([$title, $content, $category, $post_id]);
...
<section class="post-editor">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="category" class="box" required>
         ...
         <option value="nature">Individual</option>
         <option value="education">Institutional</option>
         <option value="pets and animals">Educational</option>
         <option value="technology">Treatment</option>
      </select>
      <p>post image</p>
